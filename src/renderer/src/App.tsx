...
function AppContent(): JSX.Element {
  const { claudeStatus, setClaudeStatus, currentProject, setProjects, isSidebarOpen, viewMode, showTutorial, setShowTutorial, showCommandPalette, setShowCommandPalette } =
    useAppStore()
