...
export function ThinkingBlock({ thinking, isStreaming }: ThinkingBlockProps): JSX.Element {
  ...
  return (
    <div className="mb-3 border border-border/50 rounded-lg overflow-hidden bg-secondary/30">
      ...
      {isExpanded && (
        <div className="px-3 py-2 border-t border-border/50 text-sm text-muted-foreground whitespace-pre-wrap font-mono text-xs leading-relaxed max-h-64 overflow-y-auto">
          {thinking}
          {isStreaming && (
